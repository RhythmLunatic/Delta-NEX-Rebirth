return Def.ActorFrame{
	...
	LoadActor(THEME:GetPathG("ScreenSelectMusic","rayo"))..{
	...
	LoadActor(THEME:GetPathG("ScreenSelectMusic","electric"))..{
		InitCommand=cmd(zoom,0;addy,90;);
	...
	LoadActor(THEME:GetPathG("ScreenSelectMusic","full mode"))..{
